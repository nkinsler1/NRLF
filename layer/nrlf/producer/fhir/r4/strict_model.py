...
#   timestamp: 2024-11-10T19:12:29+00:00
...
class ExpressionItem(RootModel[StrictStr]):
    root: Annotated[
        StrictStr,
        Field(
...
class ProfileItem(RootModel[StrictStr]):
    root: Annotated[
        StrictStr,
        Field(
...
class DocumentId(RootModel[StrictStr]):
    root: StrictStr
...
class RequestQueryType(RootModel[StrictStr]):
    root: Annotated[StrictStr, Field(examples=["http://snomed.info/sct|736253002"])]


class RequestQueryCategory(RootModel[StrictStr]):
...
class RequestHeaderOdsCode(RootModel[StrictStr]):
    root: StrictStr


class RequestHeaderOrganisationExtensionCode(RootModel[StrictStr]):
    root: StrictStr


class RequestHeaderRequestId(RootModel[StrictStr]):
    root: Annotated[StrictStr, Field(examples=["60E0B220-8136-4CA5-AE46-1D97EF59D068"])]


class RequestHeaderCorrelationId(RootModel[StrictStr]):
...
class Extension(BaseModel):
    ...
    url: Annotated[
        Optional[StrictStr], Field(description="The reference details for the link.")
    ] = None
