Feature: Producer - upsertDocumentReference - Duplicate Field Scenarios
  ...
  Scenario: Duplicate url field in attachment
    ...
    When producer 'TSTCUS' requests upsert of a DocumentReference with pointerId 'TSTCUS-testduplicates-upsert-0001-0001' and default test values except 'content' is:
      """
      "content": [
        {
          "attachment": {
  ...
  Scenario: Duplicate format and attachment field in content
    ...
    And the organisation 'TSTCUS' is authorised to access pointer types:
      | system                 | value     |
      | http://snomed.info/sct | 736253002 |
    When producer 'TSTCUS' requests upsert of a DocumentReference with pointerId 'TSTCUS-testduplicates-upsert-0001-0002' and default test values except 'content' is:
      """
      "content": [
        {
          "attachment": {
